...
public class PublisherTextService {
    ...
    public void publishText(String text){
        log.info("Sending text message with data " + text + " to topic " + ActiveMQConfiguration.INVENTORY_TOPIC);
        jmsTemplate.send(ActiveMQConfiguration.INVENTORY_TOPIC, new MessageCreator() {
            @Override
